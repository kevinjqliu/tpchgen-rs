...
pub(super) fn expected_schema(table: Table) -> Schema {
    match table {
        Table::CallCenter => Schema::new(vec![
        ...
        Table::CatalogPage => Schema::new(vec![
        ...
        Table::CatalogReturns => Schema::new(vec![
        ...
        Table::CatalogSales => Schema::new(vec![
        ...
        Table::CustomerAddress => Schema::new(vec![
        ...
        Table::CustomerDemographics => Schema::new(vec![
        ...
        Table::DbgenVersion => Schema::new(vec![
        ...
        Table::HouseholdDemographics => Schema::new(vec![
        ...
        Table::IncomeBand => Schema::new(vec![
        ...
        Table::Promotion => Schema::new(vec![
        ...
        Table::StoreReturns => Schema::new(vec![
        ...
        Table::WebReturns => Schema::new(vec![
        ...
        _ => unreachable!("expected schema is only defined for main TPC-DS tables"),
    }
}
